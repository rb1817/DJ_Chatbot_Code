...
function fnGetList(sGetToken){
	...
	$.ajax({
		...
		success: function(jdata) {
			...
			$("#get_view").append("<p class='box'><a href='https://youtu.be/"+jdata.items[0].id.videoId+"' target='_blank'><img src='"+this.snippet.thumbnails.default.url+"'><span>"+this.snippet.title+"</span></a></p>");
			//}).promise().done();
			console.log(res);
		},
